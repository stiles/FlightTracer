...
and optionally uploads the CSV and GeoJSON files to S3 using a specified AWS profile.
"""
...
if raw_df.empty:
    ...
    icao_str = "_".join(tracer.aircraft_ids)  # if more than one, join with underscore
